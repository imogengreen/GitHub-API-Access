...
# Description
This implementation retrieves data about the repositories belonging to the authenticated user, and then visualises them using D3.js. The data is gathered into the appropriate JSON files by running _gather.sh_. The visualisation is served using a simple HTTP server which is initialised by running the script
_run-server.sh_.
